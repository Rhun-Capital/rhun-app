export const toolCommands: { [key: string]: string } = {
  'technical-analysis': 'Show me a technical analysis for Bitcoin',
  'swap': "Let's swap tokens",
  'swap-tokens': "I want to swap tokens",
  'search-tokens': 'Search for tokens',
  'stock-analysis': 'Analyze stock data',
  'news-analysis': 'Show me crypto news for Bitcoin',
  'web-research': 'Start research',
  'tradingview-chart': 'Show me a TradingView chart for Bitcoin',
  ...
  // 'trending-tokens': 'Get for trending tokens',
