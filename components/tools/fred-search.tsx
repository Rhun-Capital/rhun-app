      ...
      <div className="bg-zinc-800/50 border border-zinc-700 rounded-lg p-4 space-y-4">
        ...
        <div className="space-y-3">
          {results.map((result: FredSeries) => (
            <div 
              key={result.id}
              className="bg-zinc-800/30 border border-zinc-700 rounded-lg p-4 hover:bg-zinc-800/50 transition-colors"
            >
              <div className="flex items-start justify-between gap-4">
                ...
                <button
                  ...
                  className="flex-shrink-0 px-3 py-1.5 text-sm font-medium text-indigo-400 hover:text-indigo-300 bg-indigo-400/10 hover:bg-indigo-400/20 rounded-lg transition-colors flex items-center gap-2"
                >
